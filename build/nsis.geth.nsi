...
# 1. install glbchain-dev for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for glbchain-dev
# 5. create glbchain-dev, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable lbchain-devEREUM_SOCKET
...
!define GROUPNAME "lbchain-devchain"
!define APPNAME "Glbchain-dev"
!define DESCRIPTION "Official Go implementation of the lbchain-devchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since glbchain-dev is installed global
