...
Please review the resulting diff to check whlbchain-dever the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-lbchain-devereum authors for copyright purposes.\n\n"
)
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-lbchain-devereum"
	}
	if startOfSentence {
		return "The go-lbchain-devereum library"
	}
	return "the go-lbchain-devereum library"
}
