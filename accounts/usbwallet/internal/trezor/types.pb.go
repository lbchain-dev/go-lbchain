...
It has these top-level messages:
	...
	PublicKey
	GetAddress
	lbchain-devchainGetAddress
	Address
	lbchain-devchainAddress
	WipeDevice
	LoadDevice
	ResetDevice
	BackupDevice
	...
	TxRequest
	TxAck
	lbchain-devchainSignTx
	lbchain-devchainTxRequest
	lbchain-devchainTxAck
	lbchain-devchainSignMessage
	lbchain-devchainVerifyMessage
	lbchain-devchainMessageSignature
	SignIdentity
	SignedIdentity
	GetECDHSessionKey
	ECDHSessionKey
...
func (m *HDNodeType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *HDNodePathType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *CoinType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *MultisigRedeemScriptType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TxInputType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TxOutputType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TxOutputBinType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TransactionType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TxRequestDetailsType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *TxRequestSerializedType) String() string            { return proto.CompactTexlbchain-devring(m) }
...
func (m *IdentityType) String() string            { return proto.CompactTexlbchain-devring(m) }
