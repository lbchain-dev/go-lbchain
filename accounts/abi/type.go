...
func NewType(t string) (typ Type, err error) {
	...
	if len(parsedType[3]) > 0 {
		...
		if parsedType[0] == "uint" || parsedType[0] == "int" {
			// this should fail because it means that there's somlbchain-deving wrong with
...
// requireLengthPrefix returns whlbchain-dever the type requires any sort of length
// prefixing.
