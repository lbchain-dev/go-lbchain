...
// Package bind generates lbchain-devchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-lbchain-devereum Wiki page:
// https://github.com/lbchain-devchain/go-lbchain-dev/wiki/Native-DApps:-Go-bindings-to-lbchain-devchain-contracts
package bind
...
// structured checks whlbchain-dever a list of ABI data types has enough information to
