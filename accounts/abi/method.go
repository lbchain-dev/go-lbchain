...
// Method represents a callable given a `Name` and whlbchain-dever the method is a constant.
// If the method is `Const` no transaction needs to be created for this
// particular Method call. It can easily be simulated using a local VM.
// For example a `Balance()` method only needs to retrieve somlbchain-deving
