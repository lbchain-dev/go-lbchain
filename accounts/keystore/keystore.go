...
// See https://github.com/lbchain-devereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whlbchain-dever the event notification loop is running
...
// HasAddress reports whlbchain-dever a key with the given address is present.
...
// ImportPreSaleKey decrypts the given lbchain-devchain presale wallet and stores
