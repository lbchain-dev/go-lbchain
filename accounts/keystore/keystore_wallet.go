...
// Status implements accounts.Wallet, returning whlbchain-dever the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain lbchain-devereum.ChainStateReader) {}
