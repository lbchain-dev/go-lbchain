...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/lbchain-devereum/pylbchain-devsaletool

		pylbchain-devsaletool generates the encryption key from password by
	...
	*/
	...
	lbchain-devPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(lbchain-devPriv)
	...
	expectedAddr := preSaleKeyStruct.lbchain-devAddr
