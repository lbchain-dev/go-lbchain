...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db lbchain-devdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
	...
	genblock := func(i int, parent *types.Block, statedb *state.StateDB) (*types.Block, types.Receipts) {
		...
		// It's nonlbchain-develess ugly to spin up a blockchain here. Get rid of this somehow.
...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (lbchain-devdb.Database, *BlockChain, error) {
	// Initialize a fresh chain with only a genesis block
	gspec := new(Genesis)
	db, _ := lbchain-devdb.NewMemDatabase()
	genesis := gspec.MustCommit(db)

	blockchain, _ := NewBlockChain(db, nil, params.Alllbchain-devashProtocolChanges, engine, vm.Config{})
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db lbchain-devdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db lbchain-devdb.Database, seed int) []*types.Block {
