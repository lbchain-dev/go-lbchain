...
func TestFastVsFullChains(t *testing.T) {
	...
	var (
		gendb, _ = lbchain-devdb.NewMemDatabase()
	...
	archiveDb, _ := lbchain-devdb.NewMemDatabase()
	...
	fastDb, _ := lbchain-devdb.NewMemDatabase()
...
//
// https://github.com/lbchain-devchain/go-lbchain-dev/pull/15941
