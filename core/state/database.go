...
// Trie is a lbchain-devchain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb lbchain-devdb.Putter) error
}
...
func NewDatabase(db lbchain-devdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb lbchain-devdb.Putter) error {
