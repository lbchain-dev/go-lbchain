...
// makeTeslbchain-devate create a sample test state to test node-wise reconstruction.
func makeTeslbchain-devate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db lbchain-devdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db lbchain-devdb.Database, root common.Hash) error {
...
func checkStateConsistency(db lbchain-devdb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTeslbchain-devate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := lbchain-devdb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(lbchain-devdb.Database), srcRoot)
