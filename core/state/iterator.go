...
// Next moves the iterator to the next node, returning whlbchain-dever there are any
...
// The method returns whlbchain-dever there are any more data left for inspection.
