...
type Context struct {
	// CanTransfer returns whlbchain-dever the account contains
	// sufficient lbchain-dever to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers lbchain-dever from one account to the other
...
// EVM is the lbchain-devchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) lbchain-devereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whlbchain-dever the max code size has been exceeded
