...
type StateDB interface {
	...
	Gelbchain-devate(common.Address, common.Hash) common.Hash
	Selbchain-devate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whlbchain-dever the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whlbchain-dever the given account is empty. Empty
