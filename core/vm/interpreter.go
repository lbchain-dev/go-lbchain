...
// Interpreter is used to run lbchain-devchain based contracts and will utilise the
...
type Interpreter struct {
	...
	readOnly   bool   // Whlbchain-dever to throw on stateful modifications
	returnData []byte // Last CALL's return data for subsequent reuse
}

// NewInterpreter returns a new instance of the Interpreter.
func NewInterpreter(evm *EVM, cfg Config) *Interpreter {
	// We use the STOP instruction whlbchain-dever to see
