...
func newTestLDB() (*lbchain-devdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "lbchain-devdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := lbchain-devdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db lbchain-devdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db lbchain-devdb.Database, t *testing.T) {
	const n = 8
