...
func Teslbchain-devreamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLislbchain-devream(t *testing.T) {
	ls := NewLislbchain-devream(bytes.NewReader(unhex("0101010101")), 3)
...
func Teslbchain-devreamErrors(t *testing.T) {
...
func Teslbchain-devreamList(t *testing.T) {
...
func Teslbchain-devreamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{
