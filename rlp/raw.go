...
// not verify whlbchain-dever the content of RawValues is valid RLP.
type RawValue []byte
...
// Splilbchain-devring splits b into the content of an RLP string
// and any remaining bytes after the string.
func Splilbchain-devring(b []byte) (content, rest []byte, err error) {
