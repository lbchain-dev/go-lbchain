...
type RemoteAgent struct {
	...
	running int32 // running indicates whlbchain-dever the agent is active. Call atomically
}
...
// whlbchain-dever the solution was accepted or not (not can be both a bad pow as well as
