...
var (
	...
	// errInvalidVote is returned if a nonce value is somlbchain-deving else that the two
...
// ecrecover extracts the lbchain-devchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the lbchain-devchain address
...
// lbchain-devchain testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     lbchain-devdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // lbchain-devchain address of the signing key
...
func New(config *params.CliqueConfig, db lbchain-devdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the lbchain-devchain address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks whlbchain-dever a header conforms to the consensus rules.
...
// verifyHeader checks whlbchain-dever a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whlbchain-dever the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whlbchain-dever the signature contained in the header satisfies the
