...
// Package consensus implements different lbchain-devchain consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the lbchain-devchain address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whlbchain-dever a header conforms to the consensus rules of a
	...
	// VerifySeal checks whlbchain-dever the crypto seal on a header is valid according to
