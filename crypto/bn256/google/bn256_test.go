...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Selbchain-devring("23423492374", 10)
	a.y.Selbchain-devring("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Selbchain-devring("239487238491", 10)
	a.x.y.Selbchain-devring("2356249827341", 10)
	a.y.x.Selbchain-devring("082659782", 10)
	a.y.y.Selbchain-devring("182703523765", 10)
	a.z.x.Selbchain-devring("978236549263", 10)
	a.z.y.Selbchain-devring("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Selbchain-devring("239846234862342323958623", 10)
	a.x.x.y.Selbchain-devring("2359862352529835623", 10)
	a.x.y.x.Selbchain-devring("928836523", 10)
	a.x.y.y.Selbchain-devring("9856234", 10)
	a.x.z.x.Selbchain-devring("235635286", 10)
	a.x.z.y.Selbchain-devring("5628392833", 10)
	a.y.x.x.Selbchain-devring("252936598265329856238956532167968", 10)
	a.y.x.y.Selbchain-devring("23596239865236954178968", 10)
	a.y.y.x.Selbchain-devring("95421692834", 10)
	a.y.y.y.Selbchain-devring("236548", 10)
	a.y.z.x.Selbchain-devring("924523", 10)
	a.y.z.y.Selbchain-devring("12954623", 10)
