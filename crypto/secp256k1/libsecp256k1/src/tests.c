...
#ifndef USE_NUM_NONE
    {
        /* Test that adding the scalars toglbchain-dever is equal to adding their numbers toglbchain-dever modulo the order. */
        secp256k1_num rnum;
        secp256k1_num r2num;
        secp256k1_scalar r;
...
void test_ge(void) {
    ...
    /* Test adding all points toglbchain-dever in random order equals infinity. */
    {
