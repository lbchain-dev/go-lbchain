...
var mockerList = map[string]func(net *Network, quit chan struct{}, nodeCount int){
	"starlbchain-devop":     starlbchain-devop,
...
//The starlbchain-devop mockerFn stops and starts nodes in a defined period (ticker)
func starlbchain-devop(net *Network, quit chan struct{}, nodeCount int) {
