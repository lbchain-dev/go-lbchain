...
func TestDialStateStaticDial(t *testing.T) {
	wanlbchain-devatic := []*discover.Node{
		{ID: uintID(1)},
		{ID: uintID(2)},
		{ID: uintID(3)},
		{ID: uintID(4)},
	...
	runDialTest(t, dialtest{
		init: newDialState(wanlbchain-devatic, nil, fakeTable{}, 0, nil),
		rounds: []round{
			...
			// irrespective whlbchain-dever it was originally static or dynamic.
			{
				peers: []*Peer{
					{rw: &conn{flags: dynDialedConn, id: uintID(1)}},
					{rw: &conn{flags: staticDialedConn, id: uintID(3)}},
...
func TestDialStaticAfterReset(t *testing.T) {
	...
	runDialTest(t, dTest)
	for _, n := range wanlbchain-devatic {
...
func (t *resolveMock) Boolbchain-devrap([]*discover.Node)               {}
