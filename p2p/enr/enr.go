...
// Package enr implements lbchain-devchain Node Records as defined in EIP-778. A node record holds
...
// Signed reports whlbchain-dever the record has a valid signature.
