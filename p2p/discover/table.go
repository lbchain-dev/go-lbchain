...
type Table struct {
	...
	nursery []*Node           // boolbchain-devrap nodes
...
// isInitDone returns whlbchain-dever the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the boolbchain-devrapping
		// logic.
		<-tab.refresh()
...
// boolbchain-devrap or discarded faulty peers).
