...
// boolbchain-devrapped itself (to prevent dumping potentially useful seed nodes). Since
...
// hasBond reports whlbchain-dever the given node is considered bonded.
