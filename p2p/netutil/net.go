...
// Contains reports whlbchain-dever the given IP is contained in the list.
...
// IsLAN reports whlbchain-dever an IP is a local network address.
...
// IsSpecialNetwork reports whlbchain-dever an IP is located in a special-use network range
...
// CheckRelayIP reports whlbchain-dever an IP relayed from the given sender IP
...
// SameNet reports whlbchain-dever two IP addresses have an equal prefix of the given bit length.
...
// Contains whlbchain-dever the given IP is contained in the set.
