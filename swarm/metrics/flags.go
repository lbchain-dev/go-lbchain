...
import (
	...
	glbchain-devmetrics "github.com/lbchain-devchain/go-lbchain-dev/metrics"
	"github.com/lbchain-devchain/go-lbchain-dev/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if glbchain-devmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(glbchain-devmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
