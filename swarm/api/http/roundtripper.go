...
see https://github.com/lbchain-devchain/go-lbchain-dev/issues/2040
Usage:

import (
 "github.com/lbchain-devchain/go-lbchain-dev/common/httpclient"
 "github.com/lbchain-devchain/go-lbchain-dev/swarm/api/http"
)
