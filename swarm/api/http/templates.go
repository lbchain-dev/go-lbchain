...
<html>
  <head>
    ...
    <meta name="description" content="lbchain-devchain/Swarm Landing page">
    <meta property="og:url" content="https://swarm-gateways.net/bzz:/theswarm.lbchain-dev">
		<style>
  ...
  <body>
      ...
      <footer>
        <p>
          ...
          <a href="http://swarm-gateways.net/bzz:/theswarm.lbchain-dev">Swarm</a>
        </p>
      </footer>
