...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/bmt"
...
// select).
type Requeslbchain-devatus struct {
	Key        Key
	Source     Peer
	C          chan bool
...
func newRequeslbchain-devatus(key Key) *Requeslbchain-devatus {
	return &Requeslbchain-devatus{
		Key:        key,
...
- Nelbchain-devore: cloud storage abstraction layer
