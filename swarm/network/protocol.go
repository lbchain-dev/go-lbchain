...
/*
bzz implements the swarm wire protocol [bzz] (sister of lbchain-dev and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Nelbchain-devore)
*/
...
import (
	...
	bzzswap "github.com/lbchain-devchain/go-lbchain-dev/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to nelbchain-devore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to nelbchain-devore
		...
		if req.isLookup() {
			...
			// swap accounting is done within nelbchain-devore
