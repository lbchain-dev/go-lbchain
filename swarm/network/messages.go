...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/swarm/network/kademlia"
	"github.com/lbchain-devchain/go-lbchain-dev/swarm/services/swap"
...
to be used to boolbchain-devrap kademlia tables.
...
Timeout serves to indicate whlbchain-dever the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whlbchain-dever responder is expected to deliver content
