...
// Package tests implements execution of lbchain-devchain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"poslbchain-devate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePoslbchain-devate(newDB); err != nil {
...
/* See https://github.com/lbchain-devereum/tests/wiki/Blockchain-Tests-II

   Whlbchain-dever a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePoslbchain-devate(statedb *state.StateDB) error {
