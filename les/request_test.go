...
type accessTestFn func(db lbchain-devdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db lbchain-devdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db lbchain-devdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db lbchain-devdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db lbchain-devdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
