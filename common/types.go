...
func (h *Hash) Selbchain-devring(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an lbchain-devchain account.
...
// IsHexAddress verifies whlbchain-dever a string can represent a valid hex-encoded
// lbchain-devchain address or not.
...
func (a *Address) Selbchain-devring(s string) { a.SetBytes([]byte(s)) }
