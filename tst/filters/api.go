...
// information related to the lbchain-devchain protocol such als blocks, transactions and logs.
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(lbchain-devereum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of lbchain-devereum.FilterQuery.
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(lbchain-devereum.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/lbchain-devereum/wiki/wiki/JSON-RPC#eth_getfilterchanges
