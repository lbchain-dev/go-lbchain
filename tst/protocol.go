...
var ProtocolName = "lbchain-dev"

// Supported versions of the lbchain-dev protocol (first is primary).
var ProtocolVersions = []uint{lbchain-dev63, lbchain-dev62}
...
// lbchain-dev protocol message codes
const (
	// Protocol messages belonging to lbchain-dev/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to lbchain-dev/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
