...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/lbchain-dev/tracers/internal/tracers"
)
...
// init retrieves the JavaScript transaction tracers included in go-lbchain-devereum.
func init() {
