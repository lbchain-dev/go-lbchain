...
func testGetNodeData(t *testing.T, protocol int) {
	...
	statedb, _ := lbchain-devdb.NewMemDatabase()
...
// Tests that post lbchain-dev protocol handshake, DAO fork-enabled clients also execute
...
func testDAOChallenge(t *testing.T, localForked, remoteForked bool, timeout bool) {
	...
	peer, _ := newTestPeer("peer", lbchain-dev63, pm, true)
	defer peer.close()
