...
// Syncing provides information when this nodes starts synchronising with the lbchain-devchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  lbchain-devereum.SyncProgress `json:"status"`
}
