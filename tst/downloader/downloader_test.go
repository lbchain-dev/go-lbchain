...
type downloadTester struct {
	...
	stateDb lbchain-devdb.Database // Database used by the tester for syncing from peers
	peerDb  lbchain-devdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := lbchain-devdb.NewMemDatabase()
	...
	tester.stateDb, _ = lbchain-devdb.NewMemDatabase()
