...
func Teslbchain-devatusMsgErrors62(t *testing.T) { teslbchain-devatusMsgErrors(t, 62) }
func Teslbchain-devatusMsgErrors63(t *testing.T) { teslbchain-devatusMsgErrors(t, 63) }

func teslbchain-devatusMsgErrors(t *testing.T, protocol int) {
