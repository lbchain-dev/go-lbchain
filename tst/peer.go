...
// PeerInfo represents a short summary of the lbchain-devchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // lbchain-devchain protocol version negotiated
...
// Handshake executes the lbchain-dev protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("lbchain-dev/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the lbchain-devchain sub-protocol.
type peerSet struct {
