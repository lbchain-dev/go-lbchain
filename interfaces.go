...
// Package lbchain-devereum defines interfaces for interacting with lbchain-devchain.
package lbchain-devereum
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whlbchain-dever the transaction has been
