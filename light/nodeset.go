...
func (db *NodeSet) Store(target lbchain-devdb.Putter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements lbchain-devdb.Putter.
type NodeList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db lbchain-devdb.Putter) {
	for _, node := range n {
