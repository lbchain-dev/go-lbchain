...
type OdrBackend interface {
	Database() lbchain-devdb.Database
...
type OdrRequest interface {
	StoreResult(db lbchain-devdb.Database)
}
...
func (req *TrieRequest) StoreResult(db lbchain-devdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db lbchain-devdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db lbchain-devdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db lbchain-devdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db lbchain-devdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db lbchain-devdb.Database) {
