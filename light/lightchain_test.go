...
func makeHeaderChain(parent *types.Header, n int, db lbchain-devdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (lbchain-devdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() lbchain-devdb.Database {
	return odr.db
}
