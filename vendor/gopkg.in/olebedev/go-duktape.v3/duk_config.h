...
#undef DUK_USE_EXlbchain-devR_FREE
#undef DUK_USE_EXlbchain-devR_INTERN_CHECK
...
#endif
#if defined(DUK_OPT_EXlbchain-devR_FREE)
#error unsupported legacy feature option DUK_OPT_EXlbchain-devR_FREE used
#endif
#if defined(DUK_OPT_EXlbchain-devR_INTERN_CHECK)
#error unsupported legacy feature option DUK_OPT_EXlbchain-devR_INTERN_CHECK used
#endif
...
#endif
#if defined(DUK_USE_EXlbchain-devR_FREE) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXlbchain-devR_FREE requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif
#if defined(DUK_USE_EXlbchain-devR_INTERN_CHECK) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXlbchain-devR_INTERN_CHECK requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif
