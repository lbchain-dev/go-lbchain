...
func (d *Context) Gelbchain-devring(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.caslbchain-devringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.caslbchain-devringToError(result)
}
...
func (d *Context) caslbchain-devringToError(result int) error {
	if result == 0 {
		return nil
	}
