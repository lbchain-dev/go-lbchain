...
func _newContext(runtime *_runtime) {
	...
	}
	{
		...
		toGMlbchain-devring_function := &_object{
			runtime:     runtime,
			class:       "Function",
			objectClass: _classObject,
			prototype:   runtime.global.FunctionPrototype,
			...
			value: _nativeFunctionObject{
				name: "toGMlbchain-devring",
				call: builtinDate_toGMlbchain-devring,
			},
		}
		toLocaleString_function := &_object{
			runtime:     runtime,
		...
		runtime.global.DatePrototype = &_object{
			...
			property: map[string]_property{
				...
				"toGMlbchain-devring": _property{
					mode: 0101,
					value: Value{
						kind:  valueObject,
						value: toGMlbchain-devring_function,
					},
				},
				"toLocaleString": _property{
					mode: 0101,
