...
// ==========
// _objeclbchain-devash
// ==========

type _objeclbchain-devash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objeclbchain-devash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjeclbchain-devash(object *_object, outer _stash) *_objeclbchain-devash {
	if object == nil {
		object = runtime.newBaseObject()
		object.class = "environment"
	}
	return &_objeclbchain-devash{
		_runtime: runtime,
		_outer:   outer,
		object:   object,
	}
...
func (in *_objeclbchain-devash) clone(clone *_clone) _stash {
	out, exists := clone.objeclbchain-devash(in)
	if exists {
		return out
	}
	*out = _objeclbchain-devash{
		clone.runtime,
...
func (self *_objeclbchain-devash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objeclbchain-devash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objeclbchain-devash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objeclbchain-devash) setValue(name string, value Value, throw bool) {
...
func (self *_objeclbchain-devash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objeclbchain-devash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objeclbchain-devash) outer() _stash {
	return self._outer
}

func (self *_objeclbchain-devash) newReference(name string, strict bool, at _at) _reference {
...
func gelbchain-devashProperties(stash _stash) (keys []string) {
