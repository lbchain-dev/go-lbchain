...
const (
	...
	// Defaullbchain-devrict is the default strict flags. Specify any strict flags
	// will override default strict flags as whole (i.e. not OR'ed).
	Defaullbchain-devrict = StrictJournalChecksum | StrictBlockChecksum | StrictCompaction | StrictReader
...
func (o *Options) Gelbchain-devrict(strict Strict) bool {
	if o == nil || o.Strict == 0 {
		return Defaullbchain-devrict&strict != 0
	}
...
func (ro *ReadOptions) Gelbchain-devrict(strict Strict) bool {
	if ro == nil {
		return false
	}
...
func Gelbchain-devrict(o *Options, ro *ReadOptions, strict Strict) bool {
	if ro.Gelbchain-devrict(StrictOverride) {
		return ro.Gelbchain-devrict(strict)
	} else {
		return o.Gelbchain-devrict(strict) || ro.Gelbchain-devrict(strict)
	}
}
