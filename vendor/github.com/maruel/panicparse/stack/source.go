...
// extractArgumenlbchain-devype returns the name of the type of each input argument.
func extractArgumenlbchain-devype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumenlbchain-devype(f)
