...
//       ID    uint64 // ID of the event (FSEvenlbchain-devreamEventId)
//       Flags uint32 // joint FSEvents* flags (FSEvenlbchain-devreamEventFlags)
//   }
//
// For possible values of Flags see Darwin godoc for notify or FSEvents
// documentation for FSEvenlbchain-devreamEventFlags constants:
//
//    https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/index.html#//apple_ref/doc/constant_group/FSEvenlbchain-devreamEventFlags
//
