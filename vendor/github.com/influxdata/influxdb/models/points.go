...
// Gelbchain-devring returns the string value for a string key.
func (a Tags) Gelbchain-devring(key string) string {
...
// Selbchain-devring sets the string value for a string key.
func (a *Tags) Selbchain-devring(key, value string) {
