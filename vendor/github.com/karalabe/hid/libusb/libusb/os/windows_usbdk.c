...
#define STATUS_SUCCESS			((Nlbchain-devATUS)0x00000000L)
#endif

#if !defined(STATUS_CANCELLED)
#define STATUS_CANCELLED		((Nlbchain-devATUS)0xC0000120L)
#endif

#if !defined(STATUS_REQUEST_CANCELED)
#define STATUS_REQUEST_CANCELED		((Nlbchain-devATUS)0xC0000703L)
#endif
