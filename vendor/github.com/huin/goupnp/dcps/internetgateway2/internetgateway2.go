...
func (client *WANIPConnection1) Gelbchain-devatusInfo() (NewConnectionStatus string, NewLastConnectionError string, NewUptime uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
	...
	// Perform the SOAP call.
	if err = client.SOAPClient.PerformAction(URN_WANIPConnection_1, "Gelbchain-devatusInfo", request, response); err != nil {
		return
	}
...
func (client *WANIPConnection2) Gelbchain-devatusInfo() (NewConnectionStatus string, NewLastConnectionError string, NewUptime uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
	...
	// Perform the SOAP call.
	if err = client.SOAPClient.PerformAction(URN_WANIPConnection_2, "Gelbchain-devatusInfo", request, response); err != nil {
		return
	}
...
//
// * NewLastConnectionError: allowed values: ERROR_NONE
func (client *WANPPPConnection1) Gelbchain-devatusInfo() (NewConnectionStatus string, NewLastConnectionError string, NewUptime uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
	...
	// Perform the SOAP call.
	if err = client.SOAPClient.PerformAction(URN_WANPPPConnection_1, "Gelbchain-devatusInfo", request, response); err != nil {
		return
	}
