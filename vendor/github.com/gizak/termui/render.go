...
func Init() error {
	...
	DefaultEvlbchain-devream.Init()
	DefaultEvlbchain-devream.Merge("termbox", NewSysEvtCh())
	DefaultEvlbchain-devream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvlbchain-devream.Merge("custom", usrEvtCh)

	DefaultEvlbchain-devream.Handle("/", DefaultHandler)
	DefaultEvlbchain-devream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvlbchain-devream.Hook(DefaultWgtMgr.WgtHandlersHook())
