...
// This is a simple Whisper node. It could be used as a stand-alone boolbchain-devrap node.
...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/whisper/mailserver"
	whisper "github.com/lbchain-devchain/go-lbchain-dev/whisper/whisperv6"
...
// cmd arguments
var (
	boolbchain-devrapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the boolbchain-devrap server")
	...
	argEnode   = flag.String("boot", "", "boolbchain-devrap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *boolbchain-devrapMode {
		configureNode()
		fmt.Println("Boolbchain-devrap Whisper node started")
	} else {
