...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the lbchain-devchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the lbchain-devchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the lbchain-devchain contract Solidity source to build and bind")
