...
// bootnode runs a boolbchain-devrap node for the lbchain-devchain Discovery Protocol.
package main
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "lbchain-devereum discovery")
		}
