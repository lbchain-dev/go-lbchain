...
// pupplbchain-dev is a command to assemble and maintain private networks.
package main
...
func main() {
	app := cli.NewApp()
	app.Name = "pupplbchain-dev"
	app.Usage = "assemble and maintain private lbchain-devchain networks"
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:  "network",
