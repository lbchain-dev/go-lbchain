...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. lbchain-devash - proof-of-work")
	...
	case choice == "1":
		...
		genesis.Config.lbchain-devash = new(params.lbchain-devashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whlbchain-dever to modify or export the genesis
	fmt.Println()
	...
	case choice == "2":
		...
		if err := ioutil.WriteFile(w.readDefaullbchain-devring(fmt.Sprintf("%s.json", w.network)), out, 0644); err != nil {
