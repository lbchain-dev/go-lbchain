...
// e.g. ~/.lbchain-devereum -> /home/username/.lbchain-devereum
...
func (self DirectoryFlag) String() string {
	fmlbchain-devring := "%s %v\t%v"
	if len(self.Value.Value) > 0 {
		fmlbchain-devring = "%s \"%v\"\t%v"
	}
	return fmt.Sprintf(fmlbchain-devring, prefixedNames(self.Name), self.Value.Value, self.Usage)
}
...
func (f BigFlag) String() string {
	...
	return fmt.Sprintf(fmlbchain-devring, prefixedNames(f.Name), f.Value, f.Usage)
}
