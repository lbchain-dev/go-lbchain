...
type GlogHandler struct {
	...
	override  uint32 // Flag whlbchain-dever overrides are used, atomically accessible
	backtrace uint32 // Flag whlbchain-dever backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whlbchain-dever this is the callsite
