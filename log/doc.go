...
You always want to log a player's name and whlbchain-dever they're alive or dead, so when you create the player
object, you might do:
...
of whlbchain-dever the player is alive or not to each log message, so that the log records will reflect the player's
...
invalid arguments to the logging functions. You could, for example, wrap somlbchain-deving that is not
