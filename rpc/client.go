...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for lbchain-devSubscribe requests
}
...
// lbchain-devSubscribe registers a subscripion under the "lbchain-dev" namespace.
func (c *Client) lbchain-devSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "lbchain-dev", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. lbchain-devSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through lbchain-devSubscribe.
