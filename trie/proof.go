...
func (t *Trie) Prove(key []byte, fromLevel uint, proofDb lbchain-devdb.Putter) error {
...
// nodes of the longest existing prefix of the key (at least the root node), ending
// with the node that proves the absence of the key.
func (t *SecureTrie) Prove(key []byte, fromLevel uint, proofDb lbchain-devdb.Putter) error {
