...
func (i *Interface) Selbchain-devring(str string)          { i.object = &str }
func (i *Interface) Selbchain-devrings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaullbchain-devring()    { i.object = new(string) }
func (i *Interface) SetDefaullbchain-devrings()   { i.object = new([]string) }
...
func (i *Interface) Gelbchain-devring() string        { return *i.object.(*string) }
func (i *Interface) Gelbchain-devrings() *Strings     { return &Strings{*i.object.(*[]string)} }
