...
// Contains a wrapper for the lbchain-devchain client.
...
// lbchain-devchainClient provides access to the lbchain-devchain APIs.
type lbchain-devchainClient struct {
	client *lbchain-devclient.Client
}

// Newlbchain-devchainClient connects a client to the given URL.
func Newlbchain-devchainClient(rawurl string) (client *lbchain-devchainClient, _ error) {
	rawClient, err := lbchain-devclient.Dial(rawurl)
	return &lbchain-devchainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *lbchain-devchainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *lbchain-devchainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *lbchain-devchainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *lbchain-devchainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *lbchain-devchainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *lbchain-devchainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *lbchain-devchainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *lbchain-devchainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *lbchain-devchainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *lbchain-devchainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
// Gelbchain-devorageAt returns the value of key in the contract storage of the given account.
// The block number can be <0, in which case the value is taken from the latest known block.
func (ec *lbchain-devchainClient) Gelbchain-devorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *lbchain-devchainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *lbchain-devchainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *lbchain-devchainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *lbchain-devchainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *lbchain-devchainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *lbchain-devchainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *lbchain-devchainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *lbchain-devchainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *lbchain-devchainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *lbchain-devchainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *lbchain-devchainClient) SendTransaction(ctx *Context, tx *Transaction) error {
