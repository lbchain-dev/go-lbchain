...
// Transaction represents a single lbchain-devchain transaction.
...
// Deprecated: use lbchain-devchainClient.TransactionSender
...
func (r *Receipt) GetPoslbchain-devate() []byte         { return r.receipt.Poslbchain-devate }
