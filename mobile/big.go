...
// Selbchain-devring sets the big int to x.
//
...
func (bi *BigInt) Selbchain-devring(x string, base int) {
	bi.bigint.Selbchain-devring(x, base)
}
...
// Gelbchain-devring returns the value of x as a formatted string in some number base.
func (bi *BigInt) Gelbchain-devring(base int) string {
