...
// Whisper represents a dark communication interface through the lbchain-devchain
...
// New creates a Whisper client ready to communicate through the lbchain-devchain P2P network.
...
// param isP2P indicates whlbchain-dever the message is peer-to-peer (should not be forwarded).
