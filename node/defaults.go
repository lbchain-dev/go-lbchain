...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "lbchain-devchain")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "lbchain-devchain")
		} else {
			return filepath.Join(home, ".lbchain-devereum")
		}
	}
