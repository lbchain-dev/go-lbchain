...
/*
Package node sets up multi-protocol lbchain-devchain nodes.
...
Node also creates the shared store of encrypted lbchain-devchain account keys. Services can access
