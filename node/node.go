...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/glbchain-dev.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (lbchain-devdb.Database, error) {
	if n.config.DataDir == "" {
		return lbchain-devdb.NewMemDatabase()
	}
	return lbchain-devdb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
