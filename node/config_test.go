...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "glbchain-dev.ipc", false, filepath.Join(os.TempDir(), "glbchain-dev.ipc")},
		{"data", "glbchain-dev.ipc", false, "data/glbchain-dev.ipc"},
		{"data", "./glbchain-dev.ipc", false, "./glbchain-dev.ipc"},
		{"data", "/glbchain-dev.ipc", false, "/glbchain-dev.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "glbchain-dev.ipc", true, `\\.\pipe\glbchain-dev.ipc`},
		{"data", "glbchain-dev.ipc", true, `\\.\pipe\glbchain-dev.ipc`},
		{"data", `\\.\pipe\glbchain-dev.ipc`, true, `\\.\pipe\glbchain-dev.ipc`},
	}
