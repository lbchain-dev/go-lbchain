...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: Alllbchain-devashProtocolChanges, new: Alllbchain-devashProtocolChanges, head: 0, wantErr: nil},
		{stored: Alllbchain-devashProtocolChanges, new: Alllbchain-devashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: Alllbchain-devashProtocolChanges,
