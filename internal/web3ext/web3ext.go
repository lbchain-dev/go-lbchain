...
// package web3ext contains glbchain-dev specific web3.js extensions.
package web3ext
...
const lbchain-dev_JS = `
web3._extend({
	property: 'lbchain-dev',
	methods: [
		new web3._extend.Method({
			name: 'sign',
			call: 'eth_sign',
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'setlbchain-deverbase',
			call: 'miner_setlbchain-deverbase',
			params: 1,
