...
import (
	...
	"github.com/lbchain-devchain/go-lbchain-dev/log/term"
	"github.com/lbchain-devchain/go-lbchain-dev/metrics"
	"github.com/lbchain-devchain/go-lbchain-dev/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. lbchain-dev/*=5,p2p=4)",
		Value: "",
	}
